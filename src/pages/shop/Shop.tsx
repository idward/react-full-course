...
import { ShopAction } from 'src/store/actions/shop.action';
  ...
  return (
    <div className="shop-page">
      <Route
        exact
        path={match.path}
        render={(props: any) => <CollectionsOverviewWithSpinner isLoading={isFetchingCollections} {...props} />}
      />
      <Route
        exact
        path={`${match.path}/:collectionName`}
        render={(props: any) => <CollectionPageWithSpinner isLoading={isFetchingCollections} {...props} />}
      />
    </div>
  );
};
...
const mapDispatchToProps = (dispatch: Dispatch<ShopAction>) => {
  return {
